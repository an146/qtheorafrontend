...
static const char *extensions[] = {
	"302", "16sv", "3g2", "3gp", "4xm", "8svx", "aac", "ac3", "aif", "aiff",
	"amv", "anim", "apc", "ape", "asf", "avs", "bf", "bfi", "c93", "cak",
	"cam", "cdata", "cin", "cmv", "cpk", "dct", "divx", "drc", "dts", "dv",
	"dxa", "ffm", "flc", "fli", "flv", "flx", "gxf", "hnm", "ilbm", "iss",
	"k3g", "m1a", "m1v", "m2a", "m4a", "m4b", "m4p", "m4r", "m4v", "mad",
	"mka", "mks", "mkv", "mm", "mov", "mp+", "mp1", "mp2", "mp3", "mp4",
	"mp4", "mpa", "mpc", "mpeg", "mpg", "mpp", "mpv", "mtv", "mve", "mvi1",
	"mvi2", "mxf", "nsv", "nut", "nuv", "oga", "ogg", "ogv", "ps", "pva",
	"qcp", "qt", "rgi", "roq", "sfd", "skm", "snd", "son", "swf", "tgq",
	"tgv", "tmv", "ts", "uv", "uv2", "vb", "vid", "vob", "voc", "vp6",
	"vqe", "vqf", "vql", "wav", "wma", "wmv", "wve",

	"261", "aa3", "asf", "au", "aud", "film", "flac", "gsm", "h263", "h264",
	"mlp", "ogm", "oma", "p64", "pcm", "r3d", "ra", "rl2", "rm", "rmvb",
	"rpl", "seq", "shn", "smk", "sol", "str", "thp", "tta", "txd", "vmd",
	"vqa", "wmv3", "wmv9", "wmva", "wmvp", "wmvr", "wv", "wvc1", "wvp2",
